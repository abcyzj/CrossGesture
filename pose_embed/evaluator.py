...
class EmbeddingSpaceEvaluator:
    ...
    def push_samples(self, generated_poses, real_poses):
        real_feat, _, _, real_recon = self.net(real_poses, variational_encoding=False)
        generated_feat, _, _, generated_recon = self.net(generated_poses, variational_encoding=False)
